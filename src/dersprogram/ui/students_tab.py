...
from ..db import Database, LESSON_TYPE_LABELS, TYPE_STUDY, STUDENT_CURRICULUM_TYPES
...
class StudentsTab(QWidget):
    def __init__(self, db: Database, on_change=None):
        ...
        right_layout.addWidget(_section_title("Hedef Birebir / Etüt Saatleri"))
        ...
        for lesson_type in STUDENT_CURRICULUM_TYPES:
    ...
    def handle_add_curriculum(self) -> None:
        ...
        self.db.add_student_curriculum(
